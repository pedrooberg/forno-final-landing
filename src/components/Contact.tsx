    ...
    <section id="contact" className="section bg-black">
      <div className="container-custom">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div 
            className="bg-black/40 backdrop-blur-md p-8 rounded-lg border border-white/10 shadow-[0_8px_32px_rgba(0,64,128,0.1)] hover:shadow-[0_8px_32px_rgba(0,128,0,0.2)] transition-all duration-500 mb-12"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.7 }}
          >
            <h3 className="text-2xl font-bold text-[#00FF00] mb-8 text-center">Direção Executiva</h3>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                ...
                <a href="mailto:pedrooberg@fornodacacau.com.br" className="text-gray-300 hover:text-italian-green transition-colors block mb-2">
                  pedrooberg@fornodacacau.com.br
                </a>
                <a href="tel:+558299624-9229" className="text-gray-300 hover:text-italian-green transition-colors">
                  (82) 99624-9229
                </a>
              </div>
              ...
              <div>
                ...
                <a href="mailto:karolyn.mello@fornodacacau.com.br" className="text-gray-300 hover:text-italian-green transition-colors block mb-2">
                  karolyn.mello@fornodacacau.com.br
                </a>
                <a href="tel:+558299946-1983" className="text-gray-300 hover:text-italian-green transition-colors">
                  (82) 99946-1983
                </a>
              </div>
            </div>
